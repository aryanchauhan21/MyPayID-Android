...
public class SearchResponseListAdapter extends RecyclerView.Adapter<SearchResponseListAdapter.MethodViewHolder> {
    private ArrayList<PaymentMethodPack> methodList;
    private LifecycleOwner lifecycleOwner;
    private Context context;

    public SearchResponseListAdapter(Context context, LifecycleOwner lifecycleOwner, ArrayList<PaymentMethodPack> methodList) {
    ...
    public MethodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_element_search, parent, false);
    ...
    public void onBindViewHolder(@NonNull MethodViewHolder holder, int position) {
        ...
        if(methodList.size()-1 == position){
            ...
            int top=5, bottom=100, left=15, right=15;
